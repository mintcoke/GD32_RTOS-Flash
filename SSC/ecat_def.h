...
#ifndef EL9800_HW
#define EL9800_HW                                 1 //This define was already evaluated by ET9300 Project Handler(V. 1.4.1.0)!
#endif
...
#ifndef _PIC24
#define _PIC24                                    1 //This define was already evaluated by ET9300 Project Handler(V. 1.4.1.0)!
#endif
...
#define ESC_EEPROM_EMULATION                      0 /* physical EEPROM, program via SSC Tool */ //This define was already evaluated by ET9300 Project Handler(V. 1.4.1.0)!
#endif
...
#ifndef DC_SUPPORTED
#define DC_SUPPORTED                              0 /* SYNC0 not wired on this hardware */
#endif
...
#define ESC_SM_WD_SUPPORTED                       0 /* software WD, more tolerant */
#endif
...
#define REVISION_NUMBER                           0x22000100
#endif
...
#define MAX_PD_INPUT_SIZE                         0x400 //This define was already evaluated by ET9300 Project Handler(V. 1.4.1.0)!
#endif
...
#define MAX_PD_OUTPUT_SIZE                        0x400 //This define was already evaluated by ET9300 Project Handler(V. 1.4.1.0)!
#endif
...
#define MIN_PD_CYCLE_TIME                         0xF4240 /* 1ms, GD32 108MHz needs more headroom */
#endif
...
#define PD_OUTPUT_CALC_AND_COPY_TIME              0x186A0
#endif
...
#define PD_INPUT_CALC_AND_COPY_TIME               0x186A0
#endif
